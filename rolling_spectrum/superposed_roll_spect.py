...
def plot_superposed_gme(gme_objs,run_times,time_prior,ax,prop_delay=datetime.timedelta(0),parameter=None):
...
def plot_superposed_bcomps(gme_objs,run_times,time_prior,ax,prop_delay=datetime.timedelta(0)):
    ...
    for st,et in run_times:
        for gme_obj in gme_objs:
            ...
            for key, dct in plot_dict.iteritems():
    ...
    for key in keys:
        ...
        for inx,series in data.iteritems():
            xvals   = series.index
            yvals   = series + offset
...
#    radars      = ['cvw']
    ...
    gme_search_periods = []
#    gme_search_periods.append( [datetime.datetime(2012,11,1), datetime.datetime(2012,12,1)] )
...
#    gme_search_periods.append( [datetime.datetime(2013,11,1), datetime.datetime(2014,2,1)] )
#    gme_search_periods.append( [datetime.datetime(2014,11,1), datetime.datetime(2015,2,1)] )
...
#    gme_dict    = {}
#    gme_dict['gme_param']   = 'ae'
#    gme_dict['epoch_title'] = gme_dict['gme_param'] 
#    gme_dict['thresh']      = (200.,None)

#    gme_dict                = {}
#    gme_dict['gme_param']   = 'omni_by'
#    gme_dict['epoch_title'] = 'omni_by_pos_morning'
#    gme_dict['radar_slt']   = (6,12)
#    gme_dict['thresh']      = (0,None)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=12)

#    gme_dict                = {}
#    gme_dict['gme_param']   = 'omni_by'
#    gme_dict['epoch_title'] = 'omni_by_neg_morning'
#    gme_dict['radar_slt']   = (6,12)
#    gme_dict['thresh']      = (None,0)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=12)

#    gme_dict                = {}
#    gme_dict['gme_param']   = 'omni_by'
#    gme_dict['epoch_title'] = 'omni_by_pos_afternoon'
#    gme_dict['radar_slt']   = (12,18)
#    gme_dict['thresh']      = (0, None)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=12)

#    gme_dict                = {}
#    gme_dict['gme_param']   = 'omni_by'
#    gme_dict['epoch_title'] = 'omni_by_neg_afternoon'
#    gme_dict['radar_slt']   = (12,18)
#    gme_dict['thresh']      = (None,0)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=12)

#    gme_dict    = {}
#    gme_dict['gme_param']   = 'omni_bz_var'
#    gme_dict['epoch_title'] = gme_dict['gme_param'] 
#    gme_dict['thresh']      = (0.,0.75)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=1)

#    gme_dict    = {}
#    gme_dict['gme_param']   = 'omni_b_var'
#    gme_dict['epoch_title'] = gme_dict['gme_param'] 
#    gme_dict['thresh']      = (0.,0.75)
#    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=1)

#    gme_dict    = {}
#    gme_dict['gme_param']   = 'omni_pdyn'
#    gme_dict['epoch_title'] = gme_dict['gme_param'] 
##    gme_dict['thresh']      = (None, 8.)
##    gme_dict['min_thresh_duration'] = datetime.timedelta(hours=1)
...
#    gme_dict['epoch_title'] = gme_dict['gme_param'] 
    ...
    for gme_search_sTime, gme_search_eTime in gme_search_periods:
        ...
        if manual_event_select:
            test_events = []
#            test_events.append(datetime.datetime(2011,11,1,8))
...
#            test_events.append(datetime.datetime(2012,12,13,12) + datetime.timedelta(hours=6))
#            test_events.append(datetime.datetime(2013,1,11,12,20) + datetime.timedelta(hours=6))
#            test_events.append(datetime.datetime(2013,1,28,12) + datetime.timedelta(hours=6))
#            test_events.append(datetime.datetime(2014,2,1,12) + datetime.timedelta(hours=6))
...
#    gme_param_plot_list = ['ae','symh','by',None]
    tmp = []
#    tmp.append('ae')
#    tmp.append('symh')
#    tmp.append('temp')
...
#    format_axis(ax,**xax_dict)
#
    for gme_param in gme_param_plot_list:
        ax_inx      += 1
        ax          = fig.add_subplot(ny_ax,nx_ax,ax_inx)
        plot_superposed_gme(gme_objs,run_times,time_prior,ax,prop_delay,parameter=gme_param)
        format_axis(ax,**xax_dict)
