...
def linkUp(dayList):
    ...
    for x in dayList:
        ...
        anc1_tag  = '<a href="'+url+'">'
        img1_tag  = '<img width="'+sz+'px" height="'+sz+'px" src="/static/img/'+img1+'.png" title="'+title1+'">'
        img2_tag  = '<img width="'+sz+'px" height="'+sz+'px" src="/static/img/'+img2+'.png" title="'+title2+'">'
        img3_tag  = '<img width="'+sz+'px" height="'+sz+'px" src="/static/img/'+img3+'.png" title="'+title3+'">'
        anc2_tag  = '</a>'
...
def get_pickle_name(radar,sDatetime,fDatetime,getPath=False,createPath=False,runfile=False,**kwargs):
...
def run_music(runfile_path,process_level='all'):
    ...
    with open(musicObj_path,'rb') as fl:
